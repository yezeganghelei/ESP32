...
#define XL9555_INVERSION_PORT0_REG    4           /* polarity inversion register：used whenP0When the port is used as input，Reversal of the input level，That is, when the pin is high，set upThis register corresponds toofThe bit is1hour，readarriveofinput register0，1The value is low0 */
#define XL9555_INVERSION_PORT1_REG    5           /* polarity inversion register：used whenP1When the port is used as input，Reversal of the input level，That is, when the pin is high，set upThis register corresponds toofThe bit is1hour，readarriveofinput register0，1The value is low0 */
