...
#define XL9555_INVERSION_PORT0_REG    4           /* polarity inversion register: used whenP0 When the port is used as input, Invert the input level, That is, when the pin is high, set up the corresponding of bit in this register is 1hour, read to ofinput register0, 1The value is low0 */
