...
#define USE_LCD_BUF    1            /* Used by defaultlcd_buf,uselcd_bufThe refresh speed will be greatly improved,Sacrifice space for speed,When there is not enough memory,Set0That’s it */
#if USE_LCD_BUF
    #if SPI_LCD_TYPE
 ...
 * @note Generally set up is L2R_U2DThat’s it. If set up is other scanning methods, it may cause abnormal display.
...
void lcd_init(void)
{
    ...
    LCD_CS(0);                  /* Lower the selection line,Select the device */
