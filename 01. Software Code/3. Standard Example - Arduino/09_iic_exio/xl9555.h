...
#define IIC_SCL       42
#define IIC_SDA       41
#define IIC_INT_PIN   0     /* Requires a jumper cap to connect */
...
#define SPK_EN                        XL_PIN_P02  /* Power amplifier enable pin P02 */
#define QMA_INT                       XL_PIN_P01  /* QMA6100P interrupt pin P01 */
#define AP_INT                        XL_PIN_P00  /* AP3216C interrupt pin P00 */

/* Device Register */
#define XL9555_INPUT_PORT0_REG        0           /* Input Register：Used for readingP0port input value */
#define XL9555_INPUT_PORT1_REG        1           /* Input Register：Used for readingP1port input value */
...
#define XL9555_INVERSION_PORT0_REG    4           /* polarity inversion register：Used whenP0When the port is used as input，Invert the input level，That is, when the pin is high level，set upThis register corresponds toofThe bit is1hour，ReadarriveofInput Register0，1The value is low0 */
#define XL9555_INVERSION_PORT1_REG    5           /* polarity inversion register：Used whenP1When the port is used as input，Invert the input level，That is, when the pin is high level，set upThis register corresponds toofThe bit is1hour，ReadarriveofInput Register0，1The value is low0 */
...
uint8_t xl9555_get_pin(uint16_t port_pin);                  /* getXL9555Configured as input functionIOstatus(High or low) */
