...
/* Define the fonts enabled by LCD */
#define FONT_12             1
#define FONT_16             1
#define FONT_24             1
#define FONT_32             1
...
void lcd_draw_hline(uint16_t x, uint16_t y, uint16_t len, uint16_t color);                    /* lcddraw horizontal line */
...
void lcd_show_num(uint16_t x, uint16_t y, uint32_t num, uint8_t len, lcd_font_t font, uint16_t color);                      /* lcdShow numbers，Not displayedhigh position0 */
