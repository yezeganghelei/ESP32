...
#define IMU_DEV_ADDR              0x12    /* 7bit device address */

#define QMA6100P_DEVICE_ID        0x90
#define QMA6100P_CHIP_ID          0x00

#define QMA6100P_XOUTL            0x01    /* QMA6100P Register X-axis acceleration address */
#define QMA6100P_XOUTH            0x02
#define QMA6100P_YOUTL            0x03    /* QMA6100PregisterYAxis acceleration address */
#define QMA6100P_YOUTH            0x04
#define QMA6100P_ZOUTL            0x05    /* QMA6100PregisterZAxis acceleration address */
...
uint8_t qma6100p_init(void);                                      /* QMA6100Pinitialization */
void qma6100p_read_reg(uint8_t reg, uint8_t *buf, uint16_t num);  /* fromQMA6100PreadNBytes of data */
void qma6100p_write_reg(uint8_t reg, uint8_t data);               /* QMA6100P register configuration */
void qma6100p_read_raw_xyz(int16_t data[3]);                      /* fromQMA6100Pregistermiddlereadoriginalx,y,zaxis data */
void qma6100p_read_acc_xyz(float accdata[3]);                     /* Calculate the accelerometerx,y,zaxis data */
