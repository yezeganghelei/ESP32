...
/* LCDThe definition of width and height */
...
void lcd_display_on(void);                                                                /* Turn on LCD backlight */
...
void lcd_fill_circle(uint16_t x, uint16_t y, uint16_t r, uint16_t color);                     /* filled circle */
...
void lcd_show_xnum(uint16_t x, uint16_t y, uint32_t num, uint8_t len,  lcd_font_t font, num_mode_t mode, uint16_t color);   /* lcdDisplay numbers，controllableshowhigh position0 */
