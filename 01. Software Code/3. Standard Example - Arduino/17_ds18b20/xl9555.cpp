...
void xl9555_pin_set(uint16_t port_pin, io_state_t state)
{
    ...
    {
        pin_value = pin_reg & (~(port_pin >> (port_pin > XL_PORT0_ALL_PIN ? 8 : 0)));       /* getarriveSomeIOset upforLow levelbackofPORTvalue but does not affect theset upofotherIOstatus */
    }
