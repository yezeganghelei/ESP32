...
#define KEY1                          XL_PIN_P16  /* Button 1pin P16 */    
...
#define XL9555_INVERSION_PORT0_REG    4           /* Polarity inversion register：used whenP0When the port is used as input，Invert the input level，That is, the pin is high levelhour，set upThis register corresponds toofThe bit is1hour，readarriveofinput register0，1The value is low0 */
#define XL9555_INVERSION_PORT1_REG    5           /* Polarity inversion register：used whenP1When the port is used as input，Invert the input level，That is, the pin is high levelhour，set upThis register corresponds toofThe bit is1hour，readarriveofinput register0，1The value is low0 */
...
void xl9555_io_config(uint16_t port_pin, io_mode_t mode);   /* set upXL9555someoneIOThe mode(Output or input) */
