...
/**
 * @brief set upLCDof automatic scanning direction
 * @note Generally set up is L2R_U2DJust. If set up is other scanning methods, it may cause abnormal display.
...
void lcd_display_dir(uint8_t dir)
{
    ...
    if (SPI_LCD_TYPE)   /* 2.4inchScreen needswantdo processing，1.3No processing required in-screen */
    {
 ...
 * @param       x     : Pictures to be displayedXcoordinate
 *              y     : Pictures to be displayedYcoordinate
 *              width : Width of the picture to be displayed
 *              height: Pictures to be displayedhigh
