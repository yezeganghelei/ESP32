...
esp_err_t sd_spi_init(void)
{
    ...
    /* SPIDriver interface configuration,SPISDCardclock is 20-25MHz */
    ...
    host.init = &sdspi_host_init;                                   /* Host function for initializing the driver */
    ...
    host.set_card_clk = &sdspi_host_set_card_clk;                   /* Host function to set up the cardclock frequency of the board */
    host.do_transaction = &sdspi_host_do_transaction;               /* Host function that executes the transaction */
    host.deinit_p = &sdspi_host_remove_device;                      /* Host function to deinitialize the driver */
...
/**
 * @brief       GetSDCard related information
