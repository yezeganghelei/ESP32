 ...
 * @param       data：Read data of storage area
 * @param       len：Read data of size
 ...
 * @param       pin     : To get the stateofIO
 ...
 * @param       config_value：IOConfiguration input or output
...
uint8_t xl9555_key_scan(uint8_t mode)
{
    ...
    if (key_up && (KEY0 == 0 || KEY1 == 0 || KEY2 == 0  || KEY3 == 0 )) /*The key release sign is 1, and any key is pressed */
    {
    ...
    else if (KEY0 == 1 && KEY1 == 1 && KEY2 == 1 && KEY3 == 1)          /* No key press, Mark button released */
    {
        key_up = 1;
    }
