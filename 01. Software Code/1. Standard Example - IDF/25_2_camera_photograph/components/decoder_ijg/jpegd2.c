...
//Initialize the resource without performing any operations
static void init_source(j_decompress_ptr cinfo)
{
    //Nothing needs to be done.
    return;
}
//Fill in the input buffer and read the whole frame of data at one time
static boolean fill_input_buffer(j_decompress_ptr cinfo)
{
    if (jbufsize == 0) { //it's over
        printf("jd read off\r\n");
        //Fill the end character
...
//In the file,jump overnum_bytesData
...
//After decoding, it is called by the jpeg_finish_decompress function
...
//initializationjpegDecode the data source
