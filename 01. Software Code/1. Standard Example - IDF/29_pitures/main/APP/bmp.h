 ...
 * @version     V1.0
 * @date        2023-12-01
 * @brief       picturedecoding-bmpdecoding Code
...
TickType_t bmp_decode(const char *filename, int width, int height); /* BMPdecoding */
