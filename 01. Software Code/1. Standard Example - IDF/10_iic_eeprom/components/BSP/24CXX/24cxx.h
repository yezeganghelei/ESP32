...
/* The development board uses24c02，So defineEE_TYPEforAT24C02 */
...
void at24cxx_write(uint16_t addr, uint8_t *pbuf, uint16_t datalen); /* Start writing data of a specified length from the specified address */
