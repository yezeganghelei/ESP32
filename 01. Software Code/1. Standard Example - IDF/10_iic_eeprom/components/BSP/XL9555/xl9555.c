 ...
 * @retval      ESP_OK: Read succeeded; other: Read failed
 */
...
/**
 * @brief       Get the state of a specific IO
 * @param       pin     : IO whose state to get
 * @retval      Value of this IO (state, 0/1)
 */
 ...
 *              KEY0_PRES, 1, KEY0 press
 *              KEY1_PRES, 2, KEY1 press
 *              KEY2_PRES, 3, KEY2 press
 *              KEY3_PRES, 4, KEY3 press
 */
uint8_t xl9555_key_scan(uint8_t mode)
{
    ...
    else if (KEY0 == 1 && KEY1 == 1 && KEY2 == 1 && KEY3 == 1)          /* No key is pressed; mark the button as released */
    {
        key_up = 1;
    }
