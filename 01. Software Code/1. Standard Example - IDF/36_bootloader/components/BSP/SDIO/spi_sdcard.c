...
esp_err_t sd_spi_init(void)
{
    ...
    host.init = &sdspi_host_init;                                   /* Host for initializing driversfunction */
    ...
    host.do_transaction = &sdspi_host_do_transaction;               /* Host function that executes transactions */
    host.deinit_p = &sdspi_host_remove_device;                      /* Host used to deinitialize the driverfunction */
