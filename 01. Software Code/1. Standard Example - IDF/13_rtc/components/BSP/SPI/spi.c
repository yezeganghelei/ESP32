...
void spi2_init(void)
{
    ...
    spi_bus_conf.max_transfer_sz = 320 * 240 * 2;                               /* Configure the maximum transfer size，in bytesBit */
...
void spi2_write_cmd(spi_device_handle_t handle, uint8_t cmd)
{
    ...
    t.length = 8;                                       /* Number of Bits to be transferred One byte 8Bit */
...
void spi2_write_data(spi_device_handle_t handle, const uint8_t *data, int len)
{
    ...
    t.length = len * 8;                             /* Number of Bits to be transferred One byte 8Bit */
