...
/* 字体信息保存首address
 * occupy33Bytes,The1Bytes用于标记Font library是否存在.Follow-up each8A group of bytes,分别保存起始addressand文件大小
 */
...
void fonts_progress_show(uint16_t x, uint16_t y, uint8_t size, uint32_t totsize, uint32_t pos, uint16_t color); /* Display current font update progress */
