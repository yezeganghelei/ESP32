    ...
    if (rval == 0)
    {
        switch (fx)
        {
            case 0: /* renew UNIGBK.BIN */
                ftinfo.ugbkaddr = FONTINFOADDR + sizeof(ftinfo);    /* After the information header，FollowUNIGBKConvert codesurface */
            ...
            case 2: /* renew GBK16.BIN */
                ftinfo.f16addr = ftinfo.f12addr + ftinfo.gbk12size; /* After GBK12, follow closely the GBK16 font library */
