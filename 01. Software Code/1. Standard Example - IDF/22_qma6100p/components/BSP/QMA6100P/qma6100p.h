...
#define QMA6100P_ADDR                     0x12      /* QMA6100P Address */

/* QMA6100P Command */

/* Get ID, default value is 0x9x */ 
#define QMA6100P_REG_CHIP_ID              0x00
/* Data register, three-axis data, default value is 0x00 */ 
...
void qma6100p_init(i2c_obj_t self);     /* Initialize a three-axis accelerometer */
...
/* Setting the acceleration register */
typedef enum
{
