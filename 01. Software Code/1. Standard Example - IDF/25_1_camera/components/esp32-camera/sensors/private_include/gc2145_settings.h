...
//////////////////////////////////////////////////////
    ...
    {0x12, 0x2e}, //sh_delay Too short YUVAbnormal picture output
    ...
    {0x1c, 0x07}, //06 After the frame rate is fast, horizontal stripes //12 //TX Width,Space Width
    {0x1d, 0x10}, //double reset
    {0x1e, 0x88}, //90//98 //fix  Vertical line//Analog Mode1,TX high,Coln_r
    {0x1f, 0x78}, //78 //38 //18 //Analog Mode2,txlow
    {0x20, 0x03}, //07 //Analog Mode3,comv,ad_clk mode
    {0x21, 0x40}, //10//20//40 //fix Horizontal stripes
    {0x22, 0xa0}, //d0//f0 //a2 //Vref vpix FPN is serious
    {0x24, 0x1e},
    {0x25, 0x01}, //col sel
    {0x26, 0x10}, //Analog PGA gain1
    {0x2d, 0x60}, //40//40 //txl drv mode
    {0x30, 0x01}, //Analog Mode4
    {0x31, 0x90}, //b0//70 // Analog Mode7 [7:5]rsgh_rLight tubeHorizontal stripes[4:3]isp_g
...
/////////////////////////////////////////////////
    {0xfe, 0x01}, //page 1
    {0x21, 0x14}, //luma_value_div_sel(dividing frequency, which is 2 times related to 0xef, increase by 1, and reduce the value of 0xef by 1)
