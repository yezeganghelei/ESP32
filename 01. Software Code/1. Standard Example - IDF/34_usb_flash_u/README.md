 ...
 * Purpose of the experiment：studyESP32-S3ofUSB MSCFunctional use,Realize the rightFLASHsimulationUplateof读写
 ...
 * 1 USBLine insertionESP32-S3Development BoardUSBAfter the port，Systemstorage分区simulation成Uplate，You can see it on your computerUplateof磁plate显示。
