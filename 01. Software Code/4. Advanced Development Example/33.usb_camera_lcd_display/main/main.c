...
#define BOARD_LCD_SPI_MISO_PIN 13
#define BOARD_LCD_SPI_MOSI_PIN 47
#define BOARD_LCD_SPI_CLK_PIN 21
#define BOARD_LCD_SPI_CS_PIN 14
#define BOARD_LCD_SPI_DC_PIN 45
#define BOARD_LCD_SPI_RESET_PIN -1
#define BOARD_LCD_SPI_BL_PIN 48
#define BOARD_LCD_TYPE SCREEN_CONTROLLER_ST7789
// #define BOARD_LCD_ST7789_DIR_MIRROR
// #define BOARD_LCD_ST7789_INVERT
#endif
