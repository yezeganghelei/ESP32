...
void avi_play(const char *filename)
{
    ...
    fseek(avi_file, AVI_file.movi_start, SEEK_SET); // offset tomovi list
    ...
    { //play loop
        ...
        Strsize = read_frame(avi_file, pbuffer, buffer_size, &Strtype); //read in whole frame
