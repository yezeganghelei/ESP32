 ...
 * @LastEditTime: 2023-07-17 11:53:27
 * @FilePath: \SP_V2_DEMO\14.avi_player\main\avi_player.c
 */
...
lv_obj_t *img_cam; //To display the image
...
void Cam_Task(void *pvParameters)
{
	...
	fseek(avi_file, AVI_file.movi_start, SEEK_SET); // Offset to movi list
	...
	{ //Play loop
		...
		Strsize = read_frame(avi_file, pbuffer, buffer_size, &Strtype); //Read the entire frame
