 ...
 * @LastEditTime: 2022-05-09 14:31:45
 * @FilePath: \S3_DEMO\16.Test\components\adc\bsp_adc.c
 */
#include "bsp_adc.h"
...
uint16_t touch_chart[][3] =
    {
        ...
        {0, 2500, 2800}, //middle button
        {1, 1150, 1350}, //right click
        {2, 1800, 2400}, //Left click
        {3, 550, 800}, //Down button
        {4, 3200, 3600}, //up key
