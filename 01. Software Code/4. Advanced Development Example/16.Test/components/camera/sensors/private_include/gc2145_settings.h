...
//////////////////////////////////////////////////////
    ...
    {0x12, 0x2e}, //sh_delay is too short, YUV image output is abnormal
    ...
    {0x21, 0x40}, //10//20//40 //fix Lamp horizontal stripes
    {0x22, 0xa0}, //d0//f0 //a2 //Vref vpix  FPNserious
    {0x24, 0x1e},
    {0x25, 0x01}, //col sel
    {0x26, 0x10}, //Analog PGA gain1
    {0x2d, 0x60}, //40//40 //txl drv mode
    {0x30, 0x01}, //Analog Mode4
    {0x31, 0x90}, //b0//70 // Analog Mode7 [7:5]rsgh_rLamp horizontal stripes[4:3]isp_g
...
/////////////////////////////////////////////////
    {0xfe, 0x01}, //page 1
    {0x21, 0x14}, //luma_value_div_sel(Frequency division，and0xefsubmit2times关系，increase1，0xefThe value of1times)
