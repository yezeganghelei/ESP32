...
#define I2C_MASTER_SCL       		5					//SCL->IO17
#define I2C_MASTER_SDA         		4              		//SDA->IO16
#define I2C_MASTER_NUM I2C_NUMBER(1) /*!< I2C port number for master dev */
#define I2C_MASTER_FREQ_HZ 		100000        /*!< I2C master clock frequency */

#define WRITE_BIT           I2C_MASTER_WRITE 					/*!< I2C master write */
#define READ_BIT            I2C_MASTER_READ  					/*!< I2C master read */
#define ACK_CHECK_EN        0x1              					/*!< I2C master will check ack from slaveThe master checks the slave'sACK*/
#define ACK_CHECK_DIS       0x0              					/*!< I2C master will not check ack from slave The master does not check the slaveACK*/
#define ACK_VAL             0x0              					/*!< I2C ack value response*/
#define NACK_VAL            0x1              					/*!< I2C nack value not responding*/
