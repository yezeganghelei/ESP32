...
//Just enter the /stream page and enter the http_get_handler function.
httpd_uri_t stream = {
    .uri = "/stream",
    .method = HTTP_GET,
...
void app_main()
{
    //Initializing nvs mainly saves the name and password of the wifi.
    ...
    //Start taking photos and uploading
