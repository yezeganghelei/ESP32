...
lv_pinyin_dict_t lv_ime_pinyin_def_dict[] = {
    ...
    { "ben", "Book" },
    { "bi", "Bibi avoids the secret of the nose and the pen" },
    { "bian", "The side becomes a mess" },
    { "biao", "Table mark" },
    { "bie", "Don't" },
    { "bing", "Sick and frozen" },
    { "bo", "bobobo" },
    ...
    { "chu", "Out of Chu Chu, touch everywhere" },
    ...
    { "cuo", "mistaken" },
    { "da", "datada" },
    { "dai", "Waiting for belt loan" },
    { "dan", "But Dan Dandan single" },
    { "dang", "Be the party, be the party" },
    { "dao", "Arrive at Dao Dao Island" },
    { "de", "Deserve" },
    { "dei", "" },
    { "deng", "wait" },
    { "di", "The land is low and the ground is low" },
    ...
    { "en", "Um" },
    { "er", "And Er'er" },
    { "fa", "Lack of method to grow hair" },
    { "fan", "Returning to the crime of selling food and selling food" },
    { "fang", "Fangfang Fangfang visit" },
    { "fei", "Non-flying fee" },
    { "fen", "portion" },
    { "feng", "Fengfeng" },
    { "fou", "No no" },
    { "fu", "The father's husband was rich, and he was paid to the Fu Fu. The wife returned to the palace." },
    ...
    { "guang", "Mitsuhiro" },
    { "gui", "regulations" },
    { "guo", "In the fruit country, in the fruit country" },
    ...
    { "mao", "fur cat trade" },
    { "me", "What?" },
    { "mei", "Every beautiful girl has no matchmaker" },
    { "men", "them" },
    { "mi", "Mi Mi Mi" },
    ...
    { "pu", "common servant" },
    { "qi", "Qi Qi Qi period weeps and expresses love for his wife" },
    { "qian", "Inlaid Qianqian lead money needle" },
    { "qiang", "strong general" },
    { "qiao", "bridge" },
    { "qie", "and exact" },
    { "qin", "Sleep frequently and kiss" },
    { "qing", "Qingqingqingqingqingqingqingqing" },
    ...
    { "shao", "Shao Shao" },
    { "shaung", "pair" },
    { "she", "Communal shooting room" },
    { "shei", "who" },
    { "shen", "So deep, so deep, so deep" },
    { "sheng", "Sheng Sheng Sheng Sheng Sheng Sheng" },
    { "shi", "This is the loss of food, the current affairs style, the ten stones, the Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Shi Ji Shi Ji" },
    { "shou", "Keep your head in hand to receive the award" },
    ...
    { "tan", "Tan Tantan" },
    { "tang", "sugar" },
    { "tao", "Tao escapes to seek revenge" },
    { "te", "special" },
    { "ti", "Ti Ti Substitute Ti Ya" },
    { "tian", "Amada" },
    { "tiao", "Tiaotiao" },
    { "tie", "Iron" },
    { "ting", "Stop the court and listen to the music" },
    { "tong", "Tongtongtongtongtongtongtong" },
    { "tou", "cast head" },
    { "tu", "Tu Tu Tea" },
    { "tuan", "group" },
    { "tui", "Push back" },
    ...
    { "wei", "Being in a dangerous position and being appointed without taste means that Wei Wei violates the siege" },
    { "wen", "Wen Wenwen" },
    { "wo", "I" },
    { "wu", "Wuwu Wuwu has no house, dead birds and dirty things" },
    { "xi", "Resting in the west, washing the joy of the past, analyzing the joy of the past" },
    { "xia", "Xia Xia Xiaoxia" },
    ...
    { "xiao", "Xiaoxiaoxiaoxiaosaki" },
    { "xie", "Write a deed of thanks for the association with some anti-evil weapons" },
    { "xin", "Xin Xinxin" },
    { "xing", "Xingxing" },
    ...
    { "xun", "training" },
    { "ya", "Yeah press" },
    { "yan", "Yanyan researches cigarettes and Yansijun tests the blood" },
    { "yang", "yangyang yang 様" },
    ...
    { "zhong", "The middle species will eventually focus on the species" },
    { "zhou", "Zhouzhou Zhouzhou Zhou" },
    { "zhu", "Help the Lord to live in Zhuzhuzhu Zhuzhu Zhuzhu Zhuzhu all kinds of attributes." },
    { "zhuan", "Specialized" },
    { "zhuang", "status" },
    { "zhui", "Chase" },
    { "zhun", "Accurate" },
