 ...
 * @LastEditTime: 2023-07-15 15:45:25
 * @FilePath: \SP_V2_DEMO\6.lcd_camera_lvgl_v7\main\app_main.c
 */
...
void app_main(void)
{
	...
	ESP_ERROR_CHECK(ret);
    /*If not usedNS4168 Just relatedIOAll the mouth is pulled down avoidIOUnstable levels causing noise*/
