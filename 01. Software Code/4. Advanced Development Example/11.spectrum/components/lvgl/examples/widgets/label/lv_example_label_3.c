...
void lv_example_label_3(void)
{
    ...
    lv_label_set_text(cz_label, "Embedded System is a computer system that is embedded inside a mechanical or electrical system and has specialized functions and real-time computing performance.");
