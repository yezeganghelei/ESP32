...
typedef void* esp_usbh_urb_handle_t;
...
typedef struct {
    int port_num;
    void *context;
    usbh_usb_fifo_bias_t fifo_bias;
 ...
 * @param port_hdl port handle return by esp_usbh_port_init
 * @return esp_err_t
 */
 ...
 * @param port_hdl the port handle returned by esp_usbh_port_init.
...
/**
 * It deinitialize a pipe, call esp_usbh_pipe_flush first before deinit
 ...
 * @param pipe_hdl the pipe handle returned by esp_usbh_pipe_init()
