 ...
 * @return a pointer to an esp_netif_t object.
 */
...
/**
 * @brief Initializes the ESP32's Wi-Fi in AP or station mode

 * @param mode wifi mode, currently only WIFI_MODE_AP supported
 * @return ** esp_netif_t*
 */
