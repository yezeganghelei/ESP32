...
/* Initialize the file system. You can initialize the internal flash or use an external TF card. The external TF card can use SPI or SDIO mode. Configure it in menuconfig. Generally, if SPI does not work, use SDIO.*/
