 ...
 * @LastEditTime: 2023-07-17 11:05:39
 * @FilePath: \SP_V2_DEMO\10.adc_button_test\components\adc\bsp_adc.c
 */
#include "bsp_adc.h"
...
uint16_t get_adc(void)
{
    ...
    // {
    read_raw = adc1_get_raw(channel); //Get ADC1 readings from a single channel.
    //     read_raw += read_raw;
    // }
