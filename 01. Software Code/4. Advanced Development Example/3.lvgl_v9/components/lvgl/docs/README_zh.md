...
  <h1 align="center">Light and Versatile Graphics Library</h1>
  <h1 align="center">Lightweight universal graphics library</h1>
  <br>
<div align="center">
...
- [Overview & Overview](#overview&overview)
  ...
  - [Already supported platforms](#already supported platforms)
...
* support多种[input device](https://docs.lvgl.io/master/overview/indev.html)：touchscreen、 keyboard、encoder、Buttons etc.
