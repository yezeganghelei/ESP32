...
<p align="right">
  <b>English</b> | <a href="./docs/README_zh.md">Chinese</a> | <a href="./docs/README_pt_BR.md">Português do Brasil</a> | <a href="./docs/README_jp.md">Japanese</a>
</p>
...
lv_label_set_text(cz_label,
                  "Embedded System is a computer system that is embedded inside a mechanical or electrical system and has specialized functions and real-time computing performance. ");
...
cz_label.set_text("Embedded System,\nis a computer system embedded inside a mechanical or electrical system with specialized functions and real-time computing performance.")
